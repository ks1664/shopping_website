...
<div class="container">
    ...
    while ($product = mysqli_fetch_array($result)) {
        ...
        <div class="row justify-content-center">
            <div class="col-sm-5" style="border-style: hidden;margin-right: 5px">
                <div class="row">
                    <div class="col-sm-5">
                        <?php
                        ...
                        <img src="<?php echo $product[5]; ?>" class="img-fluid img-responsive img-rounded"
                             style="height: 100px;width: 160px;border-style: solid;margin: 5px" id=""
                        ...
                        while ($photo = mysqli_fetch_array($res)) {
                            ...
                            <img src="<?php echo $photo[1]; ?>" class="img-fluid img-rounded img-responsive"
                                 style="height: 100px;width: 160px;border-style: inset;margin: 5px"
            ...
            <div class="col-sm-5" style="border-style: none;border-color: white;margin-bottom: inherit">
                <div class="row justify-content-center">
                    <h5><?php echo $product[1]; ?></h5>
                </div>
                <div class="row" style="border: groove white;margin-right: 10px;margin-left: 10px;margin-bottom: 10px">
                    <div class="col-sm-6">
                        <p><i class="fa fa-2x fa-rupee-sign text-info"></i><?php echo $profit; ?>&nbsp;&nbsp;
                    ...
                    <div class="col-sm-6">
                        ...
                        <p style="font-size: 13px">You save <i
                                    class="fa fa-rupee-sign text-info"></i><?php echo $discountedprice; ?>&nbsp;&nbsp;
